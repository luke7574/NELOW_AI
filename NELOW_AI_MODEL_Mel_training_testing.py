...
# 테스트 데이터셋
WAV_files_path_testing = 'MEL_Spectrogram/Testing_HP/WAV_files/'
Numpy_files_path_testing = 'MEL_Spectrogram/Testing_HP/Numpy_files/'
CSV_files_path_testing = 'MEL_Spectrogram/Testing_HP/CSV_files/'
